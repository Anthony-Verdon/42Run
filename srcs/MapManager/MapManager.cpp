...
std::vector<Tile> MapManager::UpdateTerrain(const ml::vec3 &playerPos)
{
    ...
    if (lastPlayerPos != playerPosRounded)
    {
        ...
        else if (playerPosRounded.z + 4 == 15)
        {
            Tile tile;
            tile.position = playerPosRounded + ml::vec3(ml::vec3(0, -0.5, 4));
            tile.modelIndex = 3;
            tile.transform = ml::translate(ml::mat4(1.0f), tile.position * 2.0f);
            tiles.push_back(tile);
        }
        else if (playerPosRounded.z + 4 == 20)
        {
            Tile tile;
            tile.position = playerPosRounded + ml::vec3(ml::vec3(0, -0.5, 4));
            tile.modelIndex = 4;
        ...
        else if (playerPosRounded.z + 4 == 25)
        {
            Tile tile;
            tile.position = playerPosRounded + ml::vec3(ml::vec3(0, -0.5, 4));
            tile.modelIndex = 5;
        ...
        else if (playerPosRounded.z + 4 == 30)
        {
            Tile tile;
            tile.position = playerPosRounded + ml::vec3(ml::vec3(0, -0.5, 4));
            tile.modelIndex = 6;
        ...
        else if (playerPosRounded.z + 4 == 35)
        {
            Tile tile;
            tile.position = playerPosRounded + ml::vec3(ml::vec3(0, -0.5, 4));
            tile.modelIndex = 7;
