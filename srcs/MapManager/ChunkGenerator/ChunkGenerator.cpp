...
void ChunkGenerator::Init()
{
    ...
    std::vector<std::string> paths = {
        "assets/models/tiles/low/tileLow_teamBlue.gltf.glb",
        "assets/models/slopes/lowMedium/tileSlopeLowMedium_teamBlue.gltf.glb",
        "assets/models/slopes/mediumHigh/tileSlopeMediumHigh_teamBlue.gltf.glb",
        "assets/models/gates/small/gateSmall_teamBlue.gltf.glb",
        "assets/models/gates/large/gateLarge_teamBlue.gltf.glb",
        "assets/models/tiles/low/tileLow_teamRed.gltf.glb",
        "assets/models/slopes/lowMedium/tileSlopeLowMedium_teamRed.gltf.glb",
        "assets/models/slopes/mediumHigh/tileSlopeMediumHigh_teamRed.gltf.glb",
        "assets/models/gates/small/gateSmall_teamRed.gltf.glb",
        "assets/models/gates/large/gateLarge_teamRed.gltf.glb",
        "assets/models/tiles/low/tileLow_teamYellow.gltf.glb",
        "assets/models/slopes/lowMedium/tileSlopeLowMedium_teamYellow.gltf.glb",
        "assets/models/slopes/mediumHigh/tileSlopeMediumHigh_teamYellow.gltf.glb",
        "assets/models/gates/small/gateSmall_teamYellow.gltf.glb",
        "assets/models/gates/large/gateLarge_teamYellow.gltf.glb",
        "assets/models/tiles/low/tileLow_teamGreen.gltf.glb",
        "assets/models/slopes/lowMedium/tileSlopeLowMedium_teamGreen.gltf.glb",
        "assets/models/slopes/mediumHigh/tileSlopeMediumHigh_teamGreen.gltf.glb",
        "assets/models/gates/small/gateSmall_teamGreen.gltf.glb",
        "assets/models/gates/large/gateLarge_teamGreen.gltf.glb",
        "assets/models/spikeRoller.gltf.glb",
        "assets/models/barriers/barrierSmall.gltf.glb",
        "assets/models/star.gltf.glb",
    };
